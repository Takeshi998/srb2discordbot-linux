...
# Comando para ejecutar el bot en segundo plano
bot_cmd = ["python3", "srb2discordbot_linux.py", "&"]

# Comando para ejecutar el juego en modo dedicado en segundo plano
game_cmd = ["./lsdl2srb2", "-dedicated", "&"]

# Ejecuta los comandos en segundo plano
